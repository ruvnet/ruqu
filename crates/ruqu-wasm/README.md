...
[![npm](https://img.shields.io/npm/v/ruqu-wasm.svg)](https://www.npmjs.com/package/ruqu-wasm)
...
```javascript
import init, { Circuit, Simulator } from 'ruqu-wasm';
...
```javascript
import { VQE, Hamiltonian } from 'ruqu-wasm';
